...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CAPP");
    case mBTC: return QString("mCAPP");
    case uBTC: return QString::fromUtf8("μCAPP");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BottleCapsPluss"));
    case mBTC: return QString(QObject::tr("Milli-BottleCapsPluss (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BottleCapsPluss (1 / 1,000,000)"));
    default: return QString("???");
    }
}
