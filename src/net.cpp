...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("bottlecapsplus-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("bottlecapsplus-net");
...
static const char *strDNSSeed[][2] = {
    {"bottlecapsplus.com", "dnsseed.bottlecapsplus.com"},
    {"bottlecapspluspool", "pool.bottlecapsplus.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("bottlecapsplus-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("bottlecapsplus-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("bottlecapsplus-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("bottlecapsplus-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BottleCapsPlus is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("bottlecapsplus-start");
